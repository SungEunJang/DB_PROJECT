...
$query = "SELECT * FROM Evaluation ORDER BY id DESC LIMIT $no, $page_size";
$result = mysql_query($query, $conn);

// 총 게시물 수 를 구한다.
$result_count=mysql_query("SELECT count(*) FROM Evaluation",$conn);
...
<tr height=20 bgcolor=#999999>
    ...
    <td width=370 align=center>
        <font color=white>강의 번 호 </font>
    </td>
    <td width=50 align=center>
        <font color=white>글쓴이</font>
    </td>
    <td width=60 align=center>
        <font color=white>평 점 </font>
    </td>
...
<tr>
    ...
    <td align=center height=20 bgcolor=white>
        <font color=black>
        <a href="mailto:<?=$row[lecnum]?>"><?=$row[nick]?></a>
        </font>
    </td>
    <!-- 이름 끝 -->
    <!-- 날짜 -->
    <td align=center height=20 bgcolor=white>
        <font color=black><?=$row[star]?></font>
    </td>
    <!-- 날짜 끝 -->
    <!-- 조회수 -->
    <td align=center height=20 bgcolor=white>
